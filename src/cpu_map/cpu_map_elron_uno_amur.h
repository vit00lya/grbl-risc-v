...
// Z Ограничьте вывод и ШИМ шпинделя/включите замену вывода для доступа к аппаратной ШИМ на выводе 11.
  ...
  #define SPINDLE_DIRECTION_BIT   5  // Uno Digital Pin 13 (NOTE: D13 can't be pulled-high input due to LED.) // Цифровой вывод Uno 13 (ПРИМЕЧАНИЕ: D13 не может быть извлечен - высокий вход из-за светодиода).
#endif 
